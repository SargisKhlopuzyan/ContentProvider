...
public class MyCPRecyclerViewAdapter extends RecyclerView.Adapter <MyCPRecyclerViewAdapter.CompanyViewHolder> {
    ...
    public MyCPRecyclerViewAdapter(Cursor cursor) {
        this.cursor = cursor;
    }
